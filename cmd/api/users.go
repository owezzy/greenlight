...
import (
	...
	"greenlight.owezzy.net/internal/data/validator"
)
...
func (app *application) registerUserHandler(w http.ResponseWriter, r *http.Request) {
	...
	app.background(func() {
		// As there are now multiple pieces of d that we want to pass to our email
		// templates, we create a map to act as a 'holding structure' for the d. This // contains the plaintext version of the activation token for the user, along
		// with their ID.
		d := map[string]any{
